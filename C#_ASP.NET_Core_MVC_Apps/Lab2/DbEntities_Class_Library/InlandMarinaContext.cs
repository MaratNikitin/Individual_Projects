 ...
 * This file contains the InlandMarinaContext class representing the InlandMarina database, code for creating DB table data,
	...
	public class InlandMarinaContext : DbContext
	{
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Customer>().HasData(
				new Customer { ID = 1, FirstName = "John", LastName = "Doe", Phone = "265-555-1212", City = "Phoenix", Username = "jdoe", Password = "password" },
				new Customer { ID = 2, FirstName = "Sara", LastName = "Williams", Phone = "403-555-9585", City = "Calgary", Username = "swilliams", Password = "password" },
				new Customer { ID = 3, FirstName = "Ken", LastName = "Wong", Phone = "802-555-3214", City = "Kansas City", Username = "kwong", Password = "password" }
			);
