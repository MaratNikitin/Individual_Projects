...
namespace ParserTest
{
	class Program
	{
		private static readonly string[][] TEST_DATA = new string[][]
		{
			...
			new []{ "!@#$1234test__TeSt++^-*tes3t==", "-1"}, // Marat Nikitin, April 6, 2024: I assume this last test case is incorrect as I clearly see the 'test' token twice in the first part of this object. 
		};
