...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 16, 2022 at 12:25 AM
...
CREATE TABLE `agents` (
  ...
  `AgtUserID` text NOT NULL,
  `AgtPassword` text NOT NULL
...
(4, 'John', NULL, 'Coville', '(403) 210-7823', 'john.coville@travelexperts.com', 'Intermediate Agent', 1, 'John', 'John'),
(5, 'Fred', 'J', 'Smith', '(403) 210-5555', 'fred@travelexperts.com', 'Junior Agent', 2, 'Fred', 'Fred'),
(6, 'Bruce', 'J.', 'Dixon', '(403) 210-7867', 'bruce.dixon@travelexperts.com', 'Intermediate Agent', 2, 'JDixon', 'JDixon'),
(7, 'Beverly', 'S.', 'Jones', '(403) 210-7812', 'beverly.jones@travelexperts.com', 'Intermediate Agent', 1, 'marat', 'marat'),
(8, 'Jane', NULL, 'Merrill', '(403) 210-7868', 'jane.merrill@travelexperts.com', 'Senior Agent', 2, 'group6', 'group6'),
(9, 'Brian', 'S.', 'Peterson', '(403) 210-7833', 'brian.peterson@travelexperts.com', 'Junior Agent', 2, 'test', 'test'),
(16, 'Marat', 'N.', 'Nikitin', '(403) 966-4979', 'marat@travelexperts.com', 'Agent', 1, '', '');
...
(145, 'Marat', 'Nikitin', '16 Beddington Way NE', 'Calgary', 'AB', 'T3K 1M9', 'Canada', '4039664979', '4039664979', 'maratnik1@gmail.com', 1),
(146, 'Marat', 'Nikitin', '16 Beddington Way NE', 'Calgary', 'AB', 'T3K 1M9', 'Canada', '4039664979', '4039664979', 'maratnik1@gmail.com', 2),
(147, 'Marat', 'Nikitin', '16 Beddington Way NE', 'Calgary', 'AB', 'T3K 1M9', 'Canada', '4039664979', '4039664979', 'maratnik1@gmail.com', 2),
(148, 'Marat', 'Nikitin', '16 Beddington Way NE', 'Calgary', 'AB', 'T3K 1M9', 'Canada', '4039664979', '4039664979', 'maratnik1@gmail.com', 1),
(149, 'Marat', 'Nikitin', '16 Beddington Way NE', 'Calgary', 'AB', 'T3K 1M9', 'Canada', '4039664979', '4039664979', 'maratnik1@gmail.com', 1),
(150, 'Marat', 'Nikitin', '16 Beddington Way NE', 'Calgary', 'DC', 'T3K 1M9', 'United States', '4039664979', '4039664979', 'maratnik1@gmail.com', 1),
(151, 'Marat', 'Nikitin', '16 Beddington Way NE', 'Calgary', 'SD', 'T3K 1M9', 'United States', '4039664979', '4039664979', 'maratnik1@gmail.com', 1);
...
INSERT INTO `provinces` (`ProvinceCode`, `ProvinceName`, `Country`) VALUES
('AB', 'Alberta', 'Canada'),
...
INSERT INTO `states` (`StateCode`, `StateName`, `Country`) VALUES
...
--
ALTER TABLE `users`
  ADD UNIQUE KEY `UserID_UNIQUE_INDEX` (`UserID`) USING HASH;
